...
export const columns: ColumnDef<Valve>[] = [
  {
    ...
    cell: ({ row: { original } }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <DropdownMenuItem
            onClick={() =>
              dispatchEvent(events.models.valves.navigate.to.update, {
                valveId: original.id,
              })
            }
          >
          ...
          <DropdownMenuItem
            onClick={() =>
              dispatchEvent(events.models.valves.navigate.to.detail, {
                valveId: original.id,
              })
            }
          >
          ...
          <DropdownMenuItem
            onClick={() =>
              dispatchEvent(events.models.valves.navigate.to.preview, {
                valveId: original.id,
              })
            }
          >
          ...
          <DropdownMenuItem
            ...
            onClick={() =>
              dispatchEvent(events.models.valves.delete, {
                valve: original,
              })
            }
          >
