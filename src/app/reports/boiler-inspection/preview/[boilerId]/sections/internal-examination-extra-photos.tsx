...
type InternalExaminationExtraPhotosProps = {
  internalExaminationsPerformed: BoilerInspection['internalExaminationsPerformed']
  boilerId: string
  isDownload: boolean
}

export function InternalExaminationExtraPhotos({
  internalExaminationsPerformed,
  boilerId,
  isDownload,
}: InternalExaminationExtraPhotosProps) {
    ...
    await Promise.all([
      setDoc(
        docManometerRef,
        {
          internalExaminationsPerformed: {
            ...internalExaminationsPerformed,
            extraPhotos: internalExaminationsPerformed?.extraPhotos?.map(
  ...
  return (
    <div className="w-full flex items-center justify-center flex-wrap">
      {internalExaminationsPerformed?.extraPhotos &&
        internalExaminationsPerformed?.extraPhotos.map((image, index) => {
          return (
            <ImageResizer
              key={image.id}
              image={image}
