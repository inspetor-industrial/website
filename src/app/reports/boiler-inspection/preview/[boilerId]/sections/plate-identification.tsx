...
export function PlateIdentification({
      ...
      setDoc(
        docManometerRef,
        {
          externalExaminationsPerformed: {
            ...externalExaminationsPerformed,
            plateIdentification:
              externalExaminationsPerformed?.plateIdentification?.map((doc) =>
  ...
  return (
    <div className="w-full flex items-center justify-center flex-wrap">
      {externalExaminationsPerformed?.plateIdentification &&
        externalExaminationsPerformed?.plateIdentification.map(
          (image, index) => {
            return (
              <ImageResizer
                key={image.id}
