...
type ElectricalPhotosProps = {
  gaugeOfElectricOrElectronicControlDevicesAndCommands: BoilerInspection['gaugeOfElectricOrElectronicControlDevicesAndCommands']
  boilerId: string
  isDownload: boolean
}

export function ElectricalPhotos({
  gaugeOfElectricOrElectronicControlDevicesAndCommands,
  boilerId,
  isDownload,
}: ElectricalPhotosProps) {
      ...
      setDoc(
        docManometerRef,
        {
          gaugeOfElectricOrElectronicControlDevicesAndCommands: {
            ...gaugeOfElectricOrElectronicControlDevicesAndCommands,
            photos:
              gaugeOfElectricOrElectronicControlDevicesAndCommands?.photos?.map(
  ...
  return (
    <div className="w-full flex items-center justify-center flex-wrap">
      {gaugeOfElectricOrElectronicControlDevicesAndCommands?.photos &&
        gaugeOfElectricOrElectronicControlDevicesAndCommands?.photos.map(
          (image, index) => {
            return (
              <ImageResizer
