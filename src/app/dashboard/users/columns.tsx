    ...
    cell: ({ row: { original } }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <DropdownMenuItem
            onClick={() =>
              dispatchEvent(events.models.users.navigate.to.update, {
                userId: original.id,
              })
            }
          >
          ...
          <DropdownMenuItem
            onClick={() =>
              dispatchEvent(events.models.users.navigate.to.detail, {
                userId: original.id,
              })
            }
          >
          ...
          <DropdownMenuSub>
            ...
            <DropdownMenuPortal>
              <DropdownMenuSubContent sideOffset={8}>
                <DropdownMenuItem
                  onClick={async () => await copyToClipboard(original.email)}
                >
                  Copiar email
                </DropdownMenuItem>
                <DropdownMenuItem
          ...
          <DropdownMenuItem
            ...
            onClick={() =>
              dispatchEvent(events.models.users.delete, { user: original })
            }
          >
