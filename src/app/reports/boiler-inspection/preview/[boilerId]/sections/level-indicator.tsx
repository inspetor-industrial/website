...
type LevelIndicatorProps = {
  calibrationOfTheLevelIndicatorAssembly: BoilerInspection['calibrationOfTheLevelIndicatorAssembly']
  boilerId: string
  isDownload: boolean
}

export function LevelIndicatorPhotos({
      ...
      setDoc(
        docManometerRef,
        {
          externalExaminationsPerformed: {
            ...calibrationOfTheLevelIndicatorAssembly,
            photos: calibrationOfTheLevelIndicatorAssembly?.photos?.map(
  ...
  return (
    <div className="w-full flex items-center justify-center flex-wrap">
      {calibrationOfTheLevelIndicatorAssembly?.photos &&
        calibrationOfTheLevelIndicatorAssembly?.photos.map((image, index) => {
          return (
            <ImageResizer
              key={image.id}
              image={image}
