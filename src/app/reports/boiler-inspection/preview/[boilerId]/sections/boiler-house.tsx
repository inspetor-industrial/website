...
type BoilerHousePhotosProps = {
  localInstallationExaminationsPerformed: BoilerInspection['localInstallationExaminationsPerformed']
  boilerId: string
  isDownload: boolean
}

export function BoilerHousePhotos({
  localInstallationExaminationsPerformed,
  boilerId,
  isDownload,
}: BoilerHousePhotosProps) {
      ...
      setDoc(
        docManometerRef,
        {
          localInstallationExaminationsPerformed: {
            ...localInstallationExaminationsPerformed,
            boilerHouse:
              localInstallationExaminationsPerformed?.boilerHouse?.map((doc) =>
  ...
  return (
    <div className="w-full flex items-center justify-center flex-wrap">
      {localInstallationExaminationsPerformed?.boilerHouse &&
        localInstallationExaminationsPerformed?.boilerHouse.map(
          (image, index) => {
            return (
              <ImageResizer
                key={image.id}
